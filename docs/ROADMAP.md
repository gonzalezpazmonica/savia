...
|---|---|---|---|
| **P0 · siguiente** | **SE-396: paquete de cierre verificable**. Auditar cada criterio contra los PRs #1112–#1135, fijar regresiones y lagunas, y solicitar decisión humana de graduación o deuda explícita. | 4–8 h de análisis/verificación + revisión humana | Sigue `IMPLEMENTING` hasta decisión explícita; PR #1135 mergeada no autogradúa. |
| **P0 · después** | **SE-401 I2E / L31 F0: reconciliación AEK↔Savia de solo lectura**. Resolver titularidad de contratos, reutilización de autoridad/evidencia, colisión del identificador SE-401 entre repos, dependencias y pruebas negativas; emitir propuesta de frontera y decisión go/no-go. | 8–16 h combinadas, dentro del tope L31 F0 de 120k tokens/16 h | SE-401 Savia permanece `PROPOSED`; ninguna ejecución I2E nueva antes de aprobar frontera y spec. |
...
`ACTIVE_LOW_RISK_TASKS_ONLY`. F0 está aprobado desde 2026-09-09; la ejecución
nocturna excluye decisiones arquitectónicas nuevas y nunca eleva authority.
